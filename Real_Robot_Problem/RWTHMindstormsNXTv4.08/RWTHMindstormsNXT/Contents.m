...
%   CAMERA_GetColormap         - Returns the Colormap of the NXTCam at a given Port
%   CAMERA_GetImage            - Returns an Image from the NXTCam
%   CAMERA_SetColormap         - Sets the Colormap of the NXTCam on given Port
%   CAMERA_colorMapGUI         - GUI to create and save a colormap for the NXTCam
...
%   GetCamera                  - Reads Blobs from Vision Subsystem v4 for NXT (NXTCam-v4)
...
%   GetObstacle                - Reads the current value of the Dual Range, Triple Zone Infrared Obstacle Detector for NXT (NXTSumoEyes-v2)
...
%   OpenCamera                 - Initializes the Vision Subsystem v4 for NXT (NXTCam-v4)
...
%   OpenObstacle               - Initializes the NXT Dual Range, Triple Zone Infrared Obstacle sensor, sets correct sensor mode
